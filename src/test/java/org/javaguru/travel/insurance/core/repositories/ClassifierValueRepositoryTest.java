...
class ClassifierValueRepositoryTest {
    ...
    public void shouldFind_RiskType_TRAVEL_MEDICAL() {
        getClassifierValueAndAssert("RISK_TYPE", "TRAVEL_MEDICAL");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_CANCELLATION() {
        getClassifierValueAndAssert("RISK_TYPE", "TRAVEL_CANCELLATION");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_LOSS_BAGGAGE() {
        getClassifierValueAndAssert("RISK_TYPE", "TRAVEL_LOSS_BAGGAGE");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_THIRD_PARTY_LIABILITY() {
        getClassifierValueAndAssert("RISK_TYPE", "TRAVEL_THIRD_PARTY_LIABILITY");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_EVACUATION() {
        getClassifierValueAndAssert("RISK_TYPE", "TRAVEL_EVACUATION");
    }

    @Test
    public void shouldFind_RiskType_TRAVEL_SPORT_ACTIVITIES() {
        getClassifierValueAndAssert("RISK_TYPE", "TRAVEL_SPORT_ACTIVITIES");
    }
    ...
    private void getClassifierValueAndAssert(String classifierTitle, String ic) {    Optional<ClassifierValue> valueOpt = classifierValueRepository.findByClassifierTitleAndIc(
            classifierTitle, ic);
