...
public class TravelCalculatePremiumControllerTest {
    ...
    boolean getResponseAndCompare (String receivedResponseJson, String expectResponseJson) throws  Exception {
        ...
        String expect = jsonFileReader.readJsonFromFile(
                expectResponseJson);
        return jsonResponseComparator.areJsonEqual(response,expect);
    }

    @Test
    @DisplayName("Test case 1: firstName is not filled")
    public void firstNameIsNotFilled() throws  Exception {
        assertTrue(getResponseAndCompare(
