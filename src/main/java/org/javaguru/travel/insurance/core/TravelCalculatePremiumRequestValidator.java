...
public class TravelCalculatePremiumRequestValidator {
    ...
    public List<ValidationError> validate(TravelCalculatePremiumRequest request) {
        ...
        validateDateToAfterDateFrom(request).ifPresent(errors::add);
        return errors;
    }
    ...
    private Optional<ValidationError> validateDateToAfterDateFrom(TravelCalculatePremiumRequest request) {
        return (request.getAgreementDateTo() != null &&
                ...
                ? Optional.of(new ValidationError("agreementDateTo",
                    "Must be later then agreementDateFrom!"))
                : Optional.empty();
    }
}